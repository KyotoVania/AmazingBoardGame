...
export const EVENT_CHARACTERS: Record<EventCharacterId, EventCharacterDef> = {
  TREE_GOOD: {
    ...
    emoji: '🌳',
    imageUrl: '/images/tree_good.png',
  },
  TREE_BAD: {
    id: 'TREE_BAD',
    name: "L'Arbre maudit",
    emoji: '🌳',
    imageUrl: '/images/tree_bad.png',
  },
  BOO: {
    id: 'BOO',
    name: 'Boo',
    emoji: '👻',
    imageUrl: '/images/boo.png',
  },
  MOLE: {
    id: 'MOLE',
    name: 'Topi Taupe',
    emoji: '🦫',
    imageUrl: '/images/mole.png',
  },
  TOADETTE: {
    id: 'TOADETTE',
    name: 'Toadette',
    emoji: '⭐',
    imageUrl: '/images/toadette.png',
  },
  KAMEK: {
    id: 'KAMEK',
    name: 'Kamek',
    emoji: '🧙',
    imageUrl: '/images/kamek.png',
  },
  PIT: {
    id: 'PIT',
    name: 'Le Trou',
    emoji: '🕳️',
    imageUrl: '/images/pit.png',
  },
  STAR: {
    id: 'STAR',
    name: 'Étoile',
