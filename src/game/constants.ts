...
export const ITEMS: Record<ItemId, ItemDef> = {
  ...
  GOLDEN_DRINK: {
    id: 'GOLDEN_DRINK',
    name: 'Boisson dorée',
    description: '+1 pièce par case parcourue ce tour. Inutilisable si un Peepa te colle.',
    emoji: '🥤',
    needsTarget: false,
    needsValue: false,
    price: 5,
  ...
  PEEPA_BELL: {
    id: 'PEEPA_BELL',
    name: 'Cloche Peepa',
    description: 'Un Peepa suit un rival : 1 pièce volée par case… pour toi.',
    emoji: '🔔',
    needsTarget: true,
    needsValue: false,
    price: 6,
  ...
  DUELING_GLOVE: {
    id: 'DUELING_GLOVE',
    name: 'Gant de duel',
    description: 'Duel de dés ! Le gagnant vole un allié (sinon 5 pièces), le perdant boit.',
    emoji: '🥊',
    needsTarget: true,
    needsValue: false,
    price: 8,
  ...
  DOUBLE_CARD: {
    id: 'DOUBLE_CARD',
    name: 'Double Carte',
    description: 'Ta prochaine visite chez Toadette : 2 Étoiles d’un coup (au double du prix).',
    emoji: '🎴',
    needsTarget: false,
    needsValue: false,
    price: 10,
